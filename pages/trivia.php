	...
	class Trivia {
		...
		try {
			...
			while($result = $stmt->fetch(PDO::FETCH_OBJ)) {
				...
				echo "<li id = 'correct' onclick = 'doCorrect()' onmousedown = 'clicked(0)'> $sql_correct </li>";
			}
			$stmt->closeCursor();
			...
			while($result = $stmt->fetch(PDO::FETCH_OBJ)) {
				...
				echo "<li id = 'wrong1' onclick = 'doWrong()' onmousedown = 'clicked(1)'> $sql_wrong1 </li>";
			}
			$stmt->closeCursor();
			...
			while($result = $stmt->fetch(PDO::FETCH_OBJ)) {
				...
				echo "<li id = 'wrong2' onclick = 'doWrong()' onmousedown = 'clicked(2)'> $sql_wrong2 </li>";
			}
			$stmt->closeCursor();
			...
			while($result = $stmt->fetch(PDO::FETCH_OBJ)) {
				...
				echo "<li id = 'wrong3' onclick = 'doWrong()' onmousedown = 'clicked(3)'> $sql_wrong3 </li>";
				echo "</ul>";
			}
			$stmt->closeCursor();
