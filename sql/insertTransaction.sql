...
insert into questions(question_id, question, genre_id, sub_genre_id,correct_answer_idx, game_setting_id) values(
13, #id Number#
"What is Macroeconomic output usually measured by?", #Question#
3,  #genre_id#
13, #sub_genre_id#
    (select floor(rand() * 5)),
0 #difficulty#
...
insert into questions(question_id, question, genre_id, sub_genre_id,correct_answer_idx, game_setting_id) values(
27, #id Number#
"Which body of water is off the coast of Italy and Croatia?", #Question#
6,  #genre_id#
27, #sub_genre_id#
    (select floor(rand() * 5)),
0 #difficulty#
...
insert into questions(question_id, question, genre_id, sub_genre_id,correct_answer_idx, game_setting_id) values(
42, #id Number#
"Which of these action movie stars was appointed as an UN ambassador for global justice?", #Question#
9,  #genre_id#
42, #sub_genre_id#
    (select floor(rand() * 5)),
0 #difficulty#
...
insert into wrong_answers(wrong_answer, question_id) values("2010", 1 );
